...
vim.cmd('command! Tmux lcd $HOME/.dotfiles/tmux | edit .tmux.conf')
vim.cmd('command! Sh lcd $HOME/.dotfiles/scripts/sh | Oil ~/.dotfiles/scripts/sh')
vim.cmd('command! Py lcd $HOME/.dotfiles/scripts/python | Oil ~/.dotfiles/scripts/python')
vim.cmd('command! Foot lcd $HOME/.dotfiles/foot/ | edit ~/.dotfiles/foot/foot.ini')
